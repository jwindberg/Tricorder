...
import com.marsraver.tricorder.ui.screens.TricorderMode
            ...
            Box(modifier = Modifier.width(navWidth * 2.0f).fillMaxHeight()) {
                ...
                Box(
                    ...
                    contentAlignment = Alignment.CenterEnd
                     ...
                     Text(
                        text = com.marsraver.tricorder.util.Stardate.getStardate(),
                        color = Color.Black,
                ...
                Box(
                    ...
                    Text(
                        text = com.marsraver.tricorder.util.Stardate.getTime(),
